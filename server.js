...
async function startServer() {
  ...
  app.use((err, req, res, next) => {
    ...
    console.log(`Server running on http://localhost:${PORT}`);// Inside your startServer function, add or fix the app.listen call:
    ...
    async function startServer() {
      ...
      // THIS IS THE MISSING PART - Start listening on the port
